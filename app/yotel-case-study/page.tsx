        ...
        <div className="wrap">
          <div className="detail-grid">
            <div className="prose rv">
              <h2>Overview</h2>
              <p>
                Yotel is a fast-growing, technology-led hotel group with properties in city centres, airports and
                prime destinations worldwide. As the portfolio expanded, the commercial team needed a single place
                to manage relationships across corporate clients, travel partners and direct guests — without the
                data silos that come from juggling separate tools per property.
              </p>
              <p>
                They turned to Optimiser CRM to bring sales, guest data and revenue insight onto one connected
                platform that scales across every location.
              </p>

              <h2>The challenge</h2>
              <p>
                Growth had outpaced the group&apos;s tooling. Enquiries arrived through dozens of channels, customer
                records lived in different systems, and leadership lacked a consistent, real-time view of
              ...
              <h2>The solution</h2>
              <p>
                Optimiser consolidated the group&apos;s commercial operation onto one platform. Enquiries are
                captured and routed automatically, every account carries its full history, and dashboards give
                leadership a live read across all properties.
              </p>
              <ul>
                <li>
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4">
              ...
              <h2>The results</h2>
              <p>
                With one platform in place, Yotel&apos;s teams move faster, leadership sees the full picture, and
                the commercial engine scales cleanly as new properties open.
              </p>
