...
export default function LoginV3Page() {
  ...
  const eyeIcon = (
    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z" /><circle cx="12" cy="12" r="3" /></svg>
  );
  const eyeOffIcon = (
    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-6.5 0-10-7-10-7a18.5 18.5 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c6.5 0 10 7 10 7a18.5 18.5 0 0 1-2.16 3.19M1 1l22 22" /><path d="M9.5 9.5a3 3 0 0 0 4.24 4.24" /></svg>
  );
      ...
      <div className="auth">
        ...
        <main className="panel">
          ...
          <div className="form-wrap">
            <form className={`card rv${cardIn ? ' in' : ''}${formShake ? ' shake' : ''}`} id="loginForm" noValidate onSubmit={handleSubmit}>
              ...
              <div className={`field${emailError ? ' err' : ''}`} id="f-email">
                ...
                <div className="field-wrap">
                  <span className="lead"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="M2 7l10 6 10-6" /></svg></span>
                  <input
                    ref={emailRef}
                    id="email"
                    name="email"
                ...
                <span className="msg" role="alert">Please enter your email or username</span>
              </div>
              ...
              <div className={`field${passError ? ' err' : ''}`} id="f-pass">
                ...
                <span className="msg" role="alert">Please enter your password</span>
              </div>

              <div className="opt-row">
                <label className="check">
                  <input type="checkbox" id="remember" checked={remember} onChange={(e) => setRemember(e.target.checked)} />
                  <span className="box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6L9 17l-5-5" /></svg></span>
                  Keep me signed in
                </label>
              </div>

              <div className="forgot-row">
                <a href="/forgot-password-v3">Forgot password?</a>
                <a href="/forgot-username-v3">Forgot username?</a>
              </div>
              ...
              <p className="fine">By logging in, you confirm that you agree to the <a href="#">Master Subscription Agreement</a> and <a href="#">Privacy Policy</a>.</p>
            </form>
          </div>
