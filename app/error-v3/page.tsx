...
export default function ErrorV3Page() {
  // Theme
  ...
  // error page: no form logic needed
      ...
      <div className="auth">
        ...
        <main className="panel">
          ...
          <div className="form-wrap">
            <div className={`card rv${cardIn ? ' in' : ''}`} id="errCard" role="alert" aria-live="polite">
              <span className="err-badge" aria-hidden="true">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" /><path d="M12 8v4M12 16h.01" /></svg>
              </span>
              <span className="eyebrow">Session expired</span>
              <h1>Something went wrong</h1>
              <p className="sub">Your sign-in session expired. Please start again — for your security, sessions time out after a period of inactivity.</p>

              <a className="btn btn-pri submit" href="/login-v3" id="homeBtn">Back to sign in <span className="arr">→</span></a>
              <a className="btn-gho-link" href="/">Go to homepage</a>

              <div className="help-row">
                <span>If this keeps happening</span>
                <a className="help-btn" href="mailto:support@optimiser.com">support@optimiser.com</a>
              </div>
              <p className="alt-row" style={{ marginTop: '14px', color: 'var(--mut)', fontSize: '12px' }}>Error reference · <span style={{ fontFamily: 'monospace' }}>OPT-SESSION-401</span></p>
            </div>
          </div>
