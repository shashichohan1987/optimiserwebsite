...
export const metadata = {
  title: "CRM for Marketing Teams | Optimiser",
  description:
    "Optimiser Marketing Suite for marketers — customer segmentation, campaign analytics, personalised email campaigns and sales-marketing collaboration on one platform.",
};
  ...
  return (
    <>
      ...
      <header className="whero">
        ...
        <div className="wrap">
          <div className="whero-grid">
            <div>
              <span className="eyebrow rv">Solutions · For Marketing</span>
              <h1 className="rv">
                Fuel acquisition, growth and <span className="grad-txt">customer engagement.</span>
              </h1>
              <p className="lede rv">
                Understand your audience and find new ways to market your products — measure,
                collaborate and automate with the Optimiser Marketing Suite.
              </p>
              <ul className="hero-points rv">
                <li>
                  ...
                  Precise customer segmentation with custom Contacts and Accounts tagging
                </li>
                <li>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4">
                    <path d="M20 6L9 17l-5-5" />
                  </svg>
                  Campaign analytics — bounce, CTR and conversions in simple reports
                </li>
                <li>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4">
                    <path d="M20 6L9 17l-5-5" />
                  </svg>
                  Personalised email campaigns that attract and convert more leads
                </li>
                <li>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4">
                    <path d="M20 6L9 17l-5-5" />
                  </svg>
                  Sales and marketing collaborating on the same real-time data
                </li>
              </ul>
            ...
            <div className="hero-shot rv-r">
                ...
                <div className="cb-mock">
                  <div className="cb-list">
                    ...
                    <div className="cb-row">
                      ...
                      <span className="cb-pill" style={{ background: "rgba(25,190,119,.15)", color: "#0B7A4C" }}>Engaged</span>
                    </div>
                    <div className="cb-row">
                    ...
                    <div className="cb-row">
                      ...
                      <span className="cb-pill" style={{ background: "rgba(255,170,43,.16)", color: "#8A5B00" }}>Clicked</span>
                    </div>
                    <div className="cb-row new">
                      ...
                      <span className="cb-pill" style={{ background: "rgba(0,161,223,.14)", color: "#046A93" }}>Opened</span>
                    </div>
                  </div>
                  <div className="cb-side">
                    <div className="cb-stat">
                      <span className="lb">Open rate</span>
                      <b>46%</b>
                    ...
                    <div className="cb-stat">
                      <span className="lb">Leads this week</span>
                      <b>134</b>
                    </div>
                    <div className="cb-stat">
                      <span className="lb">Campaign ROI</span>
                      <b>3.8x</b>
                    </div>
                  </div>
                </div>
              ...
              <div className="hero-chip hc1">
                <i style={{ background: "var(--green)" }}></i>Campaign sent · 2,431 recipients
              </div>
              <div className="hero-chip hc4">
                <i style={{ background: "var(--cyan)" }}></i>Segment updated · repeat buyers
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cb-dark" id="challenges">
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow">Challenges marketers face without marketing software</span>
            <h2>
              Marketing moves fast. <span className="grad-txt">Guesswork loses.</span>
            </h2>
            <p>
              Marketing is how potential consumers see your brand — yet most teams struggle to
              measure, collaborate or automate. These are the blockers.
            </p>
          </div>
          <div className="cb-ch2">
            <article className="cb-c2 rv">
              <span className="num">01</span>
              <h3>Finding the market segment</h3>
              <p>Campaigns aimed at everyone convert no one.</p>
            </article>
            <article className="cb-c2 rv">
              <span className="num">02</span>
              <h3>Business invisibility</h3>
              <p>Struggling to generate traffic, leads and brand presence.</p>
            </article>
            <article className="cb-c2 rv">
              <span className="num">03</span>
              <h3>Demonstrating ROI</h3>
              <p>No clear line from marketing activity to revenue.</p>
            </article>
            <article className="cb-c2 rv">
              <span className="num">04</span>
              <h3>No sales-marketing coordination</h3>
              <p>Two teams chasing the same customers with different messages.</p>
            </article>
            <article className="cb-c2 rv">
              <span className="num">05</span>
              <h3>Reaching global audiences</h3>
              <p>Scaling personalised communication beyond the home market.</p>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className="sec" id="help">
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow">How Optimiser helps marketers increase business presence</span>
            <h2>
              Campaigns your prospects <span className="grad-txt">actually crave</span>
            </h2>
          </div>
          <div className="cb-help">
            <article className="cb-h tall rv">
              ...
              <h3>Connect departments for smarter campaigns</h3>
              <p>
                Marketing and sales collaborate on customer-focused campaigns — with customised
                Contacts and Accounts tagging for precise segmentation, tailored content and
                higher engagement.
              </p>
              <div className="growth">
                <span className="n">3.8x</span>
                <span>campaign ROI when data replaces guesswork</span>
              </div>
            </article>
            <article className="cb-h tint-a rv">
              ...
              <h3>Tools for insightful marketing</h3>
              <p>
                Understand the user funnel across the platform to target demographics and allocate
                resources — campaign analytics report bounce, CTR and conversions simply.
              </p>
            </article>
            <article className="cb-h tint-b rv">
              ...
              <h3>Attract and convert more leads</h3>
              <p>
                Run personalised email campaigns to attract customers — design and send multiple
                unique campaigns at once for several business needs.
              </p>
            </article>
            <article className="cb-h wide tint-c rv">
              ...
              <h3>Customisable to your business needs</h3>
              <p>
                A fully customisable platform to reduce marketing cost and improve ROI —
                personalise content whether nurturing a lead or retaining a client.
              </p>
            </article>
            <article className="cb-h tint-d rv">
              ...
              <h3>Create loyal followers of your brand</h3>
              <p>
                Automations supercharge your strategies — custom email layouts, personalised per
                customer segment, boost conversions.
              </p>
            </article>
            <article className="cb-h rv">
              ...
              <h3>Translate data into strategies</h3>
              <p>
                Create content prospects crave, turn more visitors into leads, and bring the team
                together around the numbers.
              </p>
            </article>
          </div>
        </div>
        ...
        <div className="wrap">
          <div className="cb-split" style={{ marginBottom: "90px" }}>
            <div className="cb-split-left rv">
              <span className="eyebrow">Why Optimiser for marketing</span>
              <h2>
                The best CRM <span className="grad-txt">for marketing</span>
              </h2>
              <p>
                <b>Unite sales and marketing.</b> Build and organise customer segments, tailor
                communications to your audience&apos;s unique needs, and provide a leak-free
                journey that captures even more customers.
              </p>
              <p>
                <b>Waste less, return more.</b> Marketing automations cut resources wasted on
                false leads and non-tailored marketing — increasing ROI and building stronger
            ...
            <div className="cb-pillars rv">
              <article className="cb-pillar">
                ...
                <div>
                  ...
                  <p>
                    Build and organise customer segments from real behaviour — target the
              ...
              <article className="cb-pillar">
                ...
                <div>
                  ...
                  <p>
                    Tailor communications to each segment — content that prospects actually
                    crave.
                  </p>
                </div>
              </article>
              <article className="cb-pillar">
                ...
                <div>
                  ...
                  <p>
                    Data-driven insights from the client database evolve your strategies campaign
                    after campaign.
                  </p>
                </div>
              </article>
          ...
          <div className="sec-head rv" style={{ marginBottom: "28px" }}>
            <span className="eyebrow">Marketing Suite features</span>
            <h2 style={{ fontSize: "clamp(24px,3vw,36px)" }}>
              Everything a marketer needs, <span className="grad-txt">built in</span>
            </h2>
          </div>
        ...
        <div className="wrap">
          <div className="cta rv">
            ...
            <div className="inner">
              ...
              <h2>
                Take the stress out of marketing with <span className="grad-txt">one platform</span>
              </h2>
              <p>
                Create content prospects crave and turn more visitors into leads. Start your
